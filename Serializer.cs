    ...
    public class Serializer<W>
    {
        ...
        static Serializer()
        {
            ...
            if (firstPassAttribute != null)
            {
                ...
                helperType = typeof(TwoPassSerializerHelper<>).MakeGenericType(typeof(W), typeof(CompactBinaryCounter)); // BUGBUG: We pick CompactBinaryCounter because no one will ever implement this :)
            }
            else
            {
        ...
        public IEnumerable<Expression<Action<object, W>>> GetExpressions()
        {
        ...
        class SerializerHelper
        {
            ...
            readonly IEnumerable<Expression<Action<object, W>>> expressions;
